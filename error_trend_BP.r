...
ΔH_LID_401 <- LID_corr_401 - LID_pole_401
...
ΔH_LID_412 <- LID_corr_412 - LID_pole_412
...
BAR_corr_417 <- (BAR_pole_417 * PoleStandard)/PoleValue_BAR_417
LID_corr_417 <- (LID_pole_417 * PoleStandard)/PoleValue_LID_417

ΔH_BAR_417 <- BAR_corr_417 - BAR_pole_417
ΔH_LID_417 <- LID_corr_417 - LID_pole_417
...
ΔH_LID_420 <- LID_corr_420 - LID_pole_420
...
BAR_corr_437 <- (BAR_pole2_437 * PoleStandard)/PoleValue_BAR_437
LID_corr_437 <- (LID_pole2_437 * PoleStandard)/PoleValue_LID_437

ΔH_BAR_437 <- BAR_corr_437 - BAR_pole2_437
ΔH_LID_437 <- LID_corr_437 - LID_pole2_437
...
BAR_corr_440 <- (BAR_pole_440 * PoleStandard)/PoleValue_BAR_440
LID_corr_440 <- (LID_pole_440 * PoleStandard)/PoleValue_LID_440

ΔH_BAR_440 <- BAR_corr_440 - BAR_pole_440
ΔH_LID_440 <- LID_corr_440 - LID_pole_440
...
BAR_corr_444 <- (BAR_pole_444 * PoleStandard)/PoleValue_BAR_444
LID_corr_444<- (LID_pole_444 * PoleStandard)/PoleValue_LID_444

ΔH_BAR_444 <- BAR_corr_444 - BAR_pole_444
ΔH_LID_444 <- LID_corr_444 - LID_pole_444
...
BAR_corr_304 <- (BAR_pole_304 * PoleStandard)/PoleValue_BAR_304
LID_corr_304<- (LID_pole_304 * PoleStandard)/PoleValue_LID_304

ΔH_BAR_304 <- BAR_corr_304 - BAR_pole_304
ΔH_LID_304 <- LID_corr_304 - LID_pole_304
...
ggplot(FLY307_REC_MOT_LD_1.2, aes(x = seq_along(GPS.dateTimeStamp))) +
  ...
  #geom_vline(xintercept = c(302), linetype = "solid", color = "skyblue3") +
...
BAR_corr_307 <- (BAR_pole_307 * PoleStandard)/PoleValue_BAR_307
LID_corr_307 <- (LID_pole_307 * PoleStandard)/PoleValue_LID_307

ΔH_BAR_307 <- BAR_corr_307 - BAR_pole_307
ΔH_LID_307 <- LID_corr_307 - LID_pole_307
...
# frame 11 whale
BAR_11w_307 <- mean(FLY307_REC_MOT_LD_1.2$`osd_data:relativeHeight[meters]`[(334-2):(334+2)])
BAR_SD_11w_307 <- sd(FLY307_REC_MOT_LD_1.2$`osd_data:relativeHeight[meters]`[(334-2):(334+2)])
LID_11w_307 <- mean(FLY307_REC_MOT_LD_1.2$laser_altitude_m_cleaned[(334-2):(334+2)], na.rm = TRUE)
LID_SD_11w_307 <- sd(FLY307_REC_MOT_LD_1.2$laser_altitude_m_cleaned[(334-2):(334+2)], na.rm = TRUE)
...
df_307 <- data.frame(
  Flight_ID = rep("FLY307", times = 16),  
  second = c(594, 171, 184, 197, 211, 224, 240, 254, 269, 285, 318, 334, 372, 403, 419, 429),  
  Error = c(
    Error_pole_307,
    Error_1w_307,
    Error_2w_307,
