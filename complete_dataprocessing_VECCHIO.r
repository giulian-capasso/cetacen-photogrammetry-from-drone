...
# Calcola Gap 
FLY297_REC_MOT_LD_1.2 <- GAP3(FLY297_REC_MOT_LD_1.2, "laser_altitude_m_corrected", "osd_data:relativeHeight[meters]", list(c(31, 161),c(191,301),c(311,332)))
...
# Calcola Gap 
FLY316_REC_MOT_LD_1.2 <- GAP3(FLY316_REC_MOT_LD_1.2, "laser_altitude_m_corrected", "osd_data:relativeHeight[meters]", list(c(101, 175)))
...
ggplot(result_long, aes(x = seconds, y = relative_diff)) +
  ...
  labs(x = "Seconds", y = "Values", title = "differenza relativa (75 voli)") +
  theme_minimal()
...
cv_list <- list(cv_297,cv_298,cv_299,cv_304,cv_306,cv_307,cv_310,cv_311,cv_312,cv_313,cv_315,cv_316,cv_317,cv_318,cv_319,
